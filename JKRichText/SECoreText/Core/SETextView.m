...
- (void)removeSETextAttachments:(id)object
{
    UIView  *view = (UIView *)object;
    self.mouseLocation = CGPointMake(CGRectGetMinX(view.frame)+CGRectGetWidth(view.frame)-30, CGRectGetMinY(view.frame)+CGRectGetMinY(view.frame)+30);
